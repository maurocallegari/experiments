...
function updateHeader(){if(!header||!partner)return;const r=partner.getBoundingClientRect();const y=64;header.classList.toggle('on-dark',r.top<=y&&r.bottom>y);}
function update(){ticking=false;updateHero();updateCases();updateHeader();}
